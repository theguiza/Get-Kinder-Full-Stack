    ...
    return {
      ...
      data: {
        ...
        claim_review_decision: {
          decision_id: "10000000-0000-4000-8000-000000000028",
        ...
        graph_relationships: [
          ...
          { relationship_type: "evidence_located_by_source_locator", from_object_type: "evidence_item", from_object_id: EVIDENCE, to_object_type: "source_locator", to_object_id: "10000000-0000-4000-8000-000000000022" },
          ...
          { relationship_type: "source_version_from_candidate", from_object_type: "source_version", from_object_id: SOURCE_VERSION, to_object_type: "intake_source_candidate", to_object_id: "90000000-0000-4000-8000-000000000003" },
          ...
          { relationship_type: "evidence_review_queue", from_object_type: "evidence_item", from_object_id: EVIDENCE, to_object_type: "review_queue_item", to_object_id: "10000000-0000-4000-8000-000000000021" },
          { relationship_type: "claim_review_queue", from_object_type: "claim", from_object_id: claimId, to_object_type: "review_queue_item", to_object_id: "10000000-0000-4000-8000-000000000025" },
        ],
