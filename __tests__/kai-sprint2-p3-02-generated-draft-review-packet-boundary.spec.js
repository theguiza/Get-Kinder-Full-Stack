...
function evaluated(claimId = CLAIM, overrides = {}) {
  return {
    ...
    claim_review_decision: {
      decision_id: "00000000-0000-4000-8000-000000000608",
      decision_outcome: "accepted",
    ...
    graph_relationships: [
      { relationship_type: "claim_supported_by_evidence", from_object_type: "claim", from_object_id: claimId, to_object_type: "evidence_item", to_object_id: EVIDENCE },
      { relationship_type: "evidence_located_by_source_locator", from_object_type: "evidence_item", from_object_id: EVIDENCE, to_object_type: "source_locator", to_object_id: "00000000-0000-4000-8000-000000000602" },
      ...
      { relationship_type: "source_version_from_candidate", from_object_type: "source_version", from_object_id: SOURCE_VERSION, to_object_type: "intake_source_candidate", to_object_id: "00000000-0000-4000-8000-000000000604" },
      { relationship_type: "candidate_governed_by_data_dictionary", from_object_type: "intake_source_candidate", from_object_id: "00000000-0000-4000-8000-000000000604", to_object_type: "data_dictionary", to_object_id: "00000000-0000-4000-8000-000000000609" },
      { relationship_type: "candidate_governed_by_sensitivity_profile", from_object_type: "intake_source_candidate", from_object_id: "00000000-0000-4000-8000-000000000604", to_object_type: "intake_sensitivity_profile", to_object_id: "00000000-0000-4000-8000-000000000610" },
      { relationship_type: "evidence_review_queue", from_object_type: "evidence_item", from_object_id: EVIDENCE, to_object_type: "review_queue_item", to_object_id: "00000000-0000-4000-8000-000000000601" },
