...
test("Requirements readiness rollup route delegates to the requirement-assessment service and rejects an invalid organization id", async (t) => {
        ...
        requirements: [
          {
            ...
            requirement_key: "ir_pur_001",
            requirement_label: "Intended outcome is explicitly defined",
            requirement_description: "Outcome is documented.",
            display_order: 0,
            requirement_set: { requirement_set_id: "00000000-0000-4000-8000-000000000601", set_key: "purpose", set_name: "Purpose" },
            requirement_framework_version: {
              requirement_framework_version_id: "00000000-0000-4000-8000-000000000701",
              framework_code: "kai_baseline_impact_v1",
              framework_name: "KAI Baseline Impact Requirements",
              version_label: "v1",
              framework_status: "draft",
            },
            requirement_source: {
              requirement_source_id: "00000000-0000-4000-8000-000000000801",
              source_type: "kai_standard",
              source_code: "kai_baseline_impact_requirements",
              source_name: "KAI Baseline Impact Requirements",
            },
            assessed: false,
            assessment: null,
  ...
  assert.deepEqual(projectRequirementsReadiness(ok.body.data), [{
    ...
    requirementDescription: "Outcome is documented.",
    displayOrder: 0,
    requirementSet: { requirementSetId: "00000000-0000-4000-8000-000000000601", setKey: "purpose", setName: "Purpose" },
    requirementFrameworkVersion: {
      requirementFrameworkVersionId: "00000000-0000-4000-8000-000000000701",
      frameworkCode: "kai_baseline_impact_v1",
      frameworkName: "KAI Baseline Impact Requirements",
      versionLabel: "v1",
      frameworkStatus: "draft",
    },
    requirementSource: {
      requirementSourceId: "00000000-0000-4000-8000-000000000801",
      sourceType: "kai_standard",
      sourceCode: "kai_baseline_impact_requirements",
      sourceName: "KAI Baseline Impact Requirements",
    },
    assessed: false,
    assessmentId: null,
...
test("projectRequirementsReadiness surfaces an already-assessed requirement's state and explanation", () => {
    ...
    requirements: [
      {
        ...
        requirement_description: "Stakeholder group is named.",
        display_order: 4,
        requirement_set: { requirement_set_id: "00000000-0000-4000-8000-000000000602", set_key: "stakeholders", set_name: "Stakeholders" },
        requirement_framework_version: {
          requirement_framework_version_id: "00000000-0000-4000-8000-000000000702",
          framework_code: "kai_baseline_impact_v1",
          framework_name: "KAI Baseline Impact Requirements",
          version_label: "v1",
          framework_status: "draft",
        ...
        requirement_source: {
          requirement_source_id: "00000000-0000-4000-8000-000000000802",
          source_type: "kai_standard",
          source_code: "kai_baseline_impact_requirements",
          source_name: "KAI Baseline Impact Requirements",
        },
        assessed: true,
        assessment: {
          requirement_assessment_id: "00000000-0000-4000-8000-000000000902",
        ...
        assessment_provenance: {
          evidence_item_ids: ["00000000-0000-4000-8000-000000001001"],
          claim_ids: ["00000000-0000-4000-8000-000000001002"],
          evidence_review_decision_ids: ["00000000-0000-4000-8000-000000001003"],
          claim_review_decision_ids: ["00000000-0000-4000-8000-000000001004"],
          current_gap_log_item_ids: ["00000000-0000-4000-8000-000000001005"],
          outcome_context_ids: ["00000000-0000-4000-8000-000000001006"],
          source_promotion_evidence_item_ids: ["00000000-0000-4000-8000-000000001001"],
          conflict_resolution_pairs: ["00000000-0000-4000-8000-000000001007:00000000-0000-4000-8000-000000001002"],
        },
      },
    ],
  });
  assert.deepEqual(projected, [{
    ...
    requirementDescription: "Stakeholder group is named.",
    displayOrder: 4,
    requirementSet: { requirementSetId: "00000000-0000-4000-8000-000000000602", setKey: "stakeholders", setName: "Stakeholders" },
    requirementFrameworkVersion: {
      requirementFrameworkVersionId: "00000000-0000-4000-8000-000000000702",
      frameworkCode: "kai_baseline_impact_v1",
      frameworkName: "KAI Baseline Impact Requirements",
      versionLabel: "v1",
      frameworkStatus: "draft",
    ...
    requirementSource: {
      requirementSourceId: "00000000-0000-4000-8000-000000000802",
      sourceType: "kai_standard",
      sourceCode: "kai_baseline_impact_requirements",
      sourceName: "KAI Baseline Impact Requirements",
    },
    assessed: true,
    assessmentId: "00000000-0000-4000-8000-000000000902",
    ...
    assessmentProvenance: {
      evidenceItemIds: ["00000000-0000-4000-8000-000000001001"],
      claimIds: ["00000000-0000-4000-8000-000000001002"],
      evidenceReviewDecisionIds: ["00000000-0000-4000-8000-000000001003"],
      claimReviewDecisionIds: ["00000000-0000-4000-8000-000000001004"],
      currentGapLogItemIds: ["00000000-0000-4000-8000-000000001005"],
      outcomeContextIds: ["00000000-0000-4000-8000-000000001006"],
      sourcePromotionEvidenceItemIds: ["00000000-0000-4000-8000-000000001001"],
      conflictResolutionPairs: ["00000000-0000-4000-8000-000000001007:00000000-0000-4000-8000-000000001002"],
    },
  }]);
});
