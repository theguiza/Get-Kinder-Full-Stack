...
async function runExportManifestReviewBindingSuite() {
  ...
  const ENGAGEMENT = "00000000-0000-4000-8000-000000000921";
  ...
  function currentUseEvaluator(evidenceId, { eligible }) {
    return async (tx, evalInput) => ({
      ...
      data: {
        ...
        evidence_review_decision: eligible ? { decision_id: "10000000-0000-4000-8000-000000000987", decision_outcome: "accepted" } : null,
        claim_review_decision: eligible
          ? { decision_id: "10000000-0000-4000-8000-000000000988", decision_outcome: "accepted", approved_audiences: ["internal", "funder"] }
          : null,
  ...
  async function seedFullExportCandidatePipeline() {
    ...
    const created = await createEvidenceSummaryDraft(
      { organizationId: ORG, engagementId: ENGAGEMENT, requestedAudience: "internal", claimIds: [claimId], idempotencyKey: `p3-20-export-manifest-review-binding-${n}`, actorContext: gkReviewer, now: NOW },
      {
        env: enabledEnv,
