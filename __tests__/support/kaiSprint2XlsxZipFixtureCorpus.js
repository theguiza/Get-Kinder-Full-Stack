...
export const XLSX_ZIP_FIXTURE_AUTHORITY_MAP = Object.freeze({
  "OWNER_DECISION.P0_05F.XLSX_CENTRAL_DIRECTORY_BOUNDARY_V1": Object.freeze({
    ...
    section_or_decision_key: "P0-05F XLSX central-directory boundary",
    requirement_summary:
      "XLSX identity requires a ZIP local-file-header signature, readable EOCD, readable central directory, internally consistent bounds and offsets, and exact case-sensitive OOXML entry names established through parsed central-directory records.",
    supported_expected_policy: "allow",
    supported_expected_category: "type_agreement_pass",
    authority_status: "contract_grounded",
  }),
  "OWNER_DECISION.P0_05F.ZIP_CLASSIFICATION_BOUNDARY_V1": Object.freeze({
    source_document: "Backend/kai/contracts/KAI_SPRINT2_P0_REPOSITORY_CONTRACT.md",
    section_or_decision_key: "P0-05F ZIP classification boundary",
    requirement_summary:
      "Structurally readable ZIP bytes without complete XLSX identity block as standalone_archive_or_non_xlsx, while malformed or truncated ZIP/XLSX-signalling bytes block as truncated_or_malformed_type.",
...
function readableXlsxLikeFixture(args) {
  return fixture({
    ...
    authority: "OWNER_DECISION.P0_05F.ZIP_CLASSIFICATION_BOUNDARY_V1",
