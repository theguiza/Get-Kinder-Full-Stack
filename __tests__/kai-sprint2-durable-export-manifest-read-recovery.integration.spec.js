...
async function runReadRecoverySuite() {
  ...
  const ENGAGEMENT = "00000000-0000-4000-8000-000000000920";
  ...
  function currentUseEvaluator(evidenceId, { eligible }) {
    return async (tx, evalInput) => ({
      ...
      data: {
        ...
        evidence_review_decision: eligible ? { decision_id: "10000000-0000-4000-8000-000000000997", decision_outcome: "accepted" } : null,
        claim_review_decision: eligible
          ? { decision_id: "10000000-0000-4000-8000-000000000998", decision_outcome: "accepted", approved_audiences: ["internal", "funder"] }
          : null,
  ...
  async function seedFullExportCandidatePipeline() {
    ...
    const created = await createEvidenceSummaryDraft(
      { organizationId: ORG, engagementId: ENGAGEMENT, requestedAudience: "internal", claimIds: [claimId], idempotencyKey: `durable-read-recovery-${n}`, actorContext: gkAdmin, now: NOW },
      {
        env: enabledEnv,
