...
test("P3-06 real packet reports resolved/resolved, exportEligible=false, draftStatus=draft after authentic P3-13 completion, and still carries a VAL-EXP-001 blocker", async () => {
  ...
  const evaluator = async (_tx2, evalInput) => ({
    ...
    data: {
      ...
      evidence_review_decision: { decision_id: "00000000-0000-4000-8000-000000000047", decision_outcome: "accepted" },
      ...
      graph_relationships: [
        { relationship_type: "claim_supported_by_evidence", from_object_type: "claim", from_object_id: evalInput.claimId, to_object_type: "evidence_item", to_object_id: "00000000-0000-4000-8000-000000000806" },
        { relationship_type: "evidence_located_by_source_locator", from_object_type: "evidence_item", from_object_id: "00000000-0000-4000-8000-000000000806", to_object_type: "source_locator", to_object_id: "00000000-0000-4000-8000-000000000042" },
        { relationship_type: "evidence_from_source_version", from_object_type: "evidence_item", from_object_id: "00000000-0000-4000-8000-000000000806", to_object_type: "source_version", to_object_id: "00000000-0000-4000-8000-000000000044" },
        { relationship_type: "source_version_of_source", from_object_type: "source_version", from_object_id: "00000000-0000-4000-8000-000000000044", to_object_type: "source", to_object_id: "00000000-0000-4000-8000-000000000043" },
        { relationship_type: "source_version_from_candidate", from_object_type: "source_version", from_object_id: "00000000-0000-4000-8000-000000000044", to_object_type: "intake_source_candidate", to_object_id: "00000000-0000-4000-8000-000000000003" },
        { relationship_type: "candidate_governed_by_data_dictionary", from_object_type: "intake_source_candidate", from_object_id: "00000000-0000-4000-8000-000000000003", to_object_type: "data_dictionary", to_object_id: "00000000-0000-4000-8000-000000000049" },
        { relationship_type: "candidate_governed_by_sensitivity_profile", from_object_type: "intake_source_candidate", from_object_id: "00000000-0000-4000-8000-000000000003", to_object_type: "intake_sensitivity_profile", to_object_id: "00000000-0000-4000-8000-000000000050" },
        { relationship_type: "evidence_review_queue", from_object_type: "evidence_item", from_object_id: "00000000-0000-4000-8000-000000000806", to_object_type: "review_queue_item", to_object_id: "00000000-0000-4000-8000-000000000045" },
        { relationship_type: "claim_review_queue", from_object_type: "claim", from_object_id: evalInput.claimId, to_object_type: "review_queue_item", to_object_id: "00000000-0000-4000-8000-000000000045" },
      ],
