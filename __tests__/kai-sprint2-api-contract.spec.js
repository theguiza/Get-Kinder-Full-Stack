...
test("api contract exposes Sprint 2 status and admin metadata route shape", () => {
  ...
  assert.match(routeSource, /router\.post\(\s*["']\/admin\/organizations\/:organizationId\/generated-content-drafts\/:generatedContentDraftId\/export-review-request["']/);
  ...
  assert.match(routeSource, /router\.get\(\s*["']\/admin\/organizations\/:organizationId\/engagements\/:engagementId\/board-reporting["']/);
  assert.match(routeSource, /router\.post\(\s*["']\/admin\/organizations\/:organizationId\/engagements\/:engagementId\/board-reporting\/candidates["']/);
  assert.match(routeSource, /router\.get\(\s*["']\/admin\/organizations\/:organizationId\/engagements\/:engagementId\/board-reporting\/candidates\/:boardReportingCandidateId["']/);
  ...
  assert.match(routeSource, /router\.post\(\s*["']\/admin\/organizations\/:organizationId\/engagements\/:engagementId\/board-reporting\/candidates\/:boardReportingCandidateId\/review-queue\/:reviewQueueItemId\/complete["']/);
  assert.match(routeSource, /router\.get\(\s*["']\/admin\/organizations\/:organizationId\/board-reporting\/export-manifests\/:boardReportingCandidateExportManifestId\/markdown["']/);
  assert.match(routeSource, /router\.get\(\s*["']\/admin\/organizations\/:organizationId\/engagements\/:engagementId\/board-reporting\/candidates\/:boardReportingCandidateId\/workflow-state["']/);
