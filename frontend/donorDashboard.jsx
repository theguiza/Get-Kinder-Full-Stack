  ...
  return (
    <div className="donor-page">
      ...
      <div className="summary-grid">
        ...
        <div className="card">
          <div className="label">Remaining pool credits</div>
          <div className="value">
