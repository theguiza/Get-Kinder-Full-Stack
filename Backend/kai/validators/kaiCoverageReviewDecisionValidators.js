...
export const COVERAGE_REVIEW_PUBLIC_DECISION_TYPE = "accepted_public_with_limitation";
export const COVERAGE_REVIEW_DECISION_ROLE = "gk_reviewer";

export function isCoverageReviewDecisionType(value) {
  return (
    value === COVERAGE_REVIEW_DECISION_TYPE
    || value === COVERAGE_REVIEW_FUNDER_DECISION_TYPE
    || value === COVERAGE_REVIEW_PUBLIC_DECISION_TYPE
  );
}
