...
-- Drops the P1-06 canonical review-queue table and its trigger/function together.
-- No earlier-package table, column, or constraint is altered; the P1-05
-- intake_sensitivity_profiles table is left completely untouched (P1-06 never adds a
-- constraint to it - see the migration's comment on why no FK was added there).
...
DROP TABLE IF EXISTS kai.review_queue_items;
