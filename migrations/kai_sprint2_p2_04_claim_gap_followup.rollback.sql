...
DROP INDEX IF EXISTS kai.ux_review_queue_items_p2_04_client_followup_identity;

DROP TABLE IF EXISTS kai.client_followup_items;
DROP TABLE IF EXISTS kai.gap_log_items;
